			...
			<div>
				<div className='relative'>
					...
					<img
						...
						src={imgURL(movie.movie.moviePictures[1].img)}
					/>
				</div>
				<div className=''>
					...
					<div className='grid grid-cols-1 w-[8rem] mx-[5rem] mt-8 mb-8'>
						<button
							className='hover:bg-main-orangedrk text-lg bg-main-orange py-1 px-4 rounded-lg text-white font-medium text-left'
							onClick={() => {
